...
const routes = [
	...
	},
	{
		...
		children: [
			...
			{ path: 'projects/sualti-optik-spektrum-olcum-cihazi', component: lazyLoad('ProjectSpectrum') },
			{ path: 'projects/denizaltilarda-oz-akustik-kestirimi-ve-akustik-izlemeuyari-sistemi',component: lazyLoad('ProjectAcusto') },
			{ path: 'projects/denizalti-gemisi-helikopter-arasinda-guvenli-elektro-optik-haberlesme-sistemi',component: lazyLoad('ProjectElectroOptic') },
			{ path: 'contact-us', component: lazyLoad('ContactUs') },
			{ path: 'coming-soon', component: lazyLoad('ComingSoon') },
		],
	},
	{ 
		path: '/:locale/404', name: 'notFound', component: () => import('../pages/ErrorPage.vue')
	},
	{ 
		path: '/:locale/:pathMatch(.*)*',  beforeEnter (to) { window.location = `/${to.params.locale}/404`}
	},
]
